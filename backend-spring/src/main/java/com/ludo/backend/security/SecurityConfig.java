...
public class SecurityConfig {
  ...
  @Value("${ludo.platform.cors-allowed-origins:http://localhost:5173,http://localhost:5174}")
    ...
    http
        ...
        .headers(headers -> headers
            ...
            .contentSecurityPolicy(csp -> csp.policyDirectives(
                "frame-ancestors 'self' http://localhost:5173 http://localhost:5174 http://localhost:3000 http://localhost:3043"
            ))
        )
